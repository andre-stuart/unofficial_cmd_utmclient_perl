...
sub Help {
    ...
    print STDOUT ("  --server[ip/host]     -> [Required] UTM server ip or host. ex: utm.example.com\n");
    print STDOUT ("  --port[port]          -> [Optional] UTM server port [default: 9803]. ex: 9803\n");
    print STDOUT ("  --login[login/email]  -> [Required] UTM login or login\@domain. ex: user\@domain.com\n");
    ...
    print STDOUT ("  > perl utmauth.pl --action login --server utm.example.com --login user\@domain.com --pass \"*******\"\n");
    print STDOUT ("  > perl utmauth.pl --action logout --server utm.example.com --login user\@domain.com\n");
    print STDOUT ("  > perl utmauth.pl --action keepalive --server utm.example.com --login user\@domain.com\n");
    print STDOUT ("\n");
